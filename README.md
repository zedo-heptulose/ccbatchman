...
|----------|-------------|
| [INPUT_GENERATION.md](docs/INPUT_GENERATION.md) | WorkflowGenerator API for creating calculation workflows |
| [BATCH_RUNNER.md](docs/BATCH_RUNNER.md) | Running and managing batch jobs with SLURM |
| [DATA_PROCESSING.md](docs/DATA_PROCESSING.md) | Parsing output files and extracting data |
| [RESTART_HANDLING.md](docs/RESTART_HANDLING.md) | Automatic job restart and failure recovery |
| [FILE_PARSER.md](docs/FILE_PARSER.md) | Custom rule-based output file parsing |
| [PROGCHECK.md](docs/PROGCHECK.md) | Job status checking and failure analysis |
| [EDITOR.md](docs/EDITOR.md) | Coordinate/orbital transfer between jobs |
| [JOB_HARNESS.md](docs/JOB_HARNESS.md) | Per-job state management |
